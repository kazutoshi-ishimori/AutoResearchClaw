...
def _stage10_tabular_cpu_budget_guidance(
    *,
    ...
    return (
        ...
        "- Do not create alias baselines such as `Standard Conformal Prediction` "
        "or `Calibrated Prediction Sets`; if you need standard conformal, it "
        "MUST be the single condition named `split_cp_baseline`.\n"
        ...
        "- Print machine-readable lines for every condition, seed, and metric "
        "as `condition=<name> seed=<seed> <metric>: <float>`, including "
        "coverage_rate, coverage_gap, and average_prediction_set_size. Do not "
        "put average_prediction_set_size only in a markdown summary table.\n"
